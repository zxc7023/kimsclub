...
<%--         <a href="https://github.com/nhnent/tui.calendar">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu-calendarType">
                    ...
                    <li role="presentation">
                        <a class="dropdown-menu-title" role="menuitem" data-action="toggle-weeks2">
                            <i class="calendar-icon ic_view_week"></i>2 주
                        </a>
                    </li>
                    <li role="presentation">
                        <a class="dropdown-menu-title" role="menuitem" data-action="toggle-weeks3">
                            <i class="calendar-icon ic_view_week"></i>3 주
                        </a>
                    </li>
                    ...
                    <li role="presentation">
                        <a role="menuitem" data-action="toggle-start-day-1">
                            ...
                            <span class="checkbox-title"></span>월요일부터 주 시작
                        </a>
                    </li>
                    <li role="presentation">
    ...
    <script src="${pageContext.request.contextPath}/resources/toast/dist/tui-calendar.js"></script>
    <script src="${pageContext.request.contextPath}/resources/toast/js/data/calendars.js"></script>
    <script src="${pageContext.request.contextPath}/resources/toast/js/data/schedules.js"></script>
    <script src="${pageContext.request.contextPath}/resources/toast/js/theme/dooray.js"></script>
    <script src="${pageContext.request.contextPath}/resources/toast/js/default.js"></script>
</body>
</html>