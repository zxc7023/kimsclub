...
<!--  -->
<!-- <div class="wrap-btn2">
<input class="form-inputPop2" type="checkbox" id="checkbox02"  checked="checked" onChange="scheduleChoice(1, 'qansohiecib58ga9k1bmppvt5oi65b1q@import.calendar.google.com','#f27d4a', '#FFFFFF');"/>
<i></i>
