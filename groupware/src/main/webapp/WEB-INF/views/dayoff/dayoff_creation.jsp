										...
										<tr role="row">
											...
											<td colspan="${fn:length(requestScope.DayoffCreateTerms)}">
												...
												<div>
													...
													<small>위 조건으로 전 직원의 연차 휴가를 생성(재설정)합니다. 생성 조건이 회사 규정에 맞지 않으면 설정을 변경한 후 이용하세요.</small> <a href="${pageContext.request.contextPath}/dayoff/dayoffSetting">연차 휴가 설정 변경 바로가기</a>
												</div>
												<div>
													<input type="checkbox" checked="checked">
													<small> 입사일이 입력되지 않은 사용자는 휴가가 생성되지 않습니다. 휴가 대상자를 먼저 확인하시기 바랍니다</small> <a href="#">회원관리 바로가기</a>
												</div>
											</td>
										</tr>
									</tbody>
								</table>
								<div><button>지금생성</button> </div>
							</div>
