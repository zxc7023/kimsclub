...
$(document).ready(function() {
	...
	$('.pg-scale').change(function() {
		location.href = 'proceedDocList?page_scale=' + $(this).val()+'&keyword=${map.keyword}<c:forEach items="${map.searchOption}" var="searchOption">&searchOption=${searchOption}</c:forEach>';
	});
});
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">진행 문서함</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
								...
								<div class="row">
									...
									<form action="proceedDocList">
										...
										<div class="col-lg-3">
											...
											<label><input type="checkbox" name="searchOption" value="document_writer_no" multiple="multiple">기안자</label>
										</div>
										<div class="col-lg-4">
									...
									<tbody>
										<c:forEach items="${dlist}" var="list">
											<tr>
												...
												<td>${list.employee.employee_name}</td>
