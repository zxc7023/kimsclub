...
$(document).ready(function() {
	...
	$('.pg-scale').change(function() {
		location.href = 'approvalDocList?page_scale=' + $(this).val()+'&keyword=${map.keyword}<c:forEach items="${map.searchOption}" var="searchOption">&searchOption=${searchOption}</c:forEach>';
	});
});
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">결재 문서함</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
