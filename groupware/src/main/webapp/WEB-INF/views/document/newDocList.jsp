...
$(document).ready(function() {
	...
	$("#modify-btn").click(function(){
		if($('.check:checked').val()==null){
			...
			window.location.href = "javascript:post_to_url('/groupware/modifyNewDoc',{'document_no':"+$('.check:checked').val()+"})";
		}
	});
	...
	$('.pg-scale').change(function() {
		location.href = 'newDocList?page_scale=' + $(this).val()+'&keyword=${map.keyword}<c:forEach items="${map.searchOption}" var="searchOption">&searchOption=${searchOption}</c:forEach>';
	});
