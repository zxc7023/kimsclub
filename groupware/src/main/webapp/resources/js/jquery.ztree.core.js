  ...
  var settings = {}, roots = {}, caches = {},
    ...
    view = {
      ...
      makeDOMNodeMainBefore: function (html, setting, node) {
        html.push("<li role='presentation' id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' treenode>");
      },
      ...
      makeDOMNodeNameBefore: function (html, setting, node) {
        ...
        html.push("<a role='menuitem' id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level, "' treeNode", consts.id.A, " onclick=\"", (node.click || ''),
